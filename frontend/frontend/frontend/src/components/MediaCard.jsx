        ...
        <div className="top-container relative px-4">
          <div className="media-heading w-full flex flex-col justify-center content-center md:flex-row">
            <div className="media-image mx-auto">
              <picture>
                <source type="image/webp" srcSet={`${POSTER_IMG + mediaArr.poster_path}.webp`} />
                <source type="image/jpeg" srcSet={`${POSTER_IMG + mediaArr.poster_path}.jpeg`} />
                <img
                  srcSet={`
            ...
            <div className="media-description my-2 md:my-auto w-full mx-auto md:mx-4 text-center md:text-center md:max-w-[500px]">
              ...
              <div className="genre-container max-w-[350px] my-2 mx-auto flex flex-row flex-wrap justify-evenly md:justify-around">
                {genres.map((genre, index) => (
                  <p className="py-1 px-3 m-1 md:my-[2px] md:ml-0 md:mr-2 bg-slate-900" key={index}>
                    {genre.name}
                  </p>
                ))}
              </div>
                  ...
                  <SwiperSlide key={index}>
                    <picture>
                      ...
                      <img
                        ...
                        `}
                        src={
                          credit.profile_path !== null ? POSTER_IMG + credit.profile_path : NO_IMAGE
                        }
                        alt={`${
                          credit.title === undefined ? 'No title image' : `${credit.title} image`
                        }`}
                      />
                    </picture>
                    <div
                    ...
                    <Link to={`/${media.media_type}/${media.id}`}>
                      <picture>
                        ...
                        <img
                          ...
                          loading="lazy"
                          srcSet={`
                          ${POSTER_IMG + media.backdrop_path}.jpg?width=100 100w,
                          ${POSTER_IMG + media.backdrop_path}.jpg?width=200 200w
                        `}
                          src={media.backdrop_path ? BACKDROP_IMG + media.backdrop_path : NO_IMAGE}
                          alt={`${
